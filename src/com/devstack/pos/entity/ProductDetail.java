...
public class ProductDetail implements SuperEntity {
    ...
    public ProductDetail(String code, String barcode, int qtyOnHand, double sellingPrice, double buyingPrice, boolean discountAvailability, double showPrice, int productCode) {
        this.code = code;
