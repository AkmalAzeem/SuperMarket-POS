...
public class ProductMainFormController {
    ...
    public void loadExternalUi(boolean state, ProductDetailTm tm) throws IOException {
        if (!txtSelectedProdId.getId().trim().isEmpty()){
            ...
            controller.setDetails(Integer.parseInt(txtSelectedProdId.getText()),txtSelectedProdDescription.getText(),stage, state,tm);
